                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.star,color: Palette.primaryColor,size: 17.sp,),
                          Icon(Icons.star,color: Palette.primaryColor,size: 17.sp,),
                          Icon(Icons.star,color: Palette.primaryColor,size: 17.sp,),
                          Icon(Icons.star,color: Palette.primaryColor,size: 17.sp,),
                          Icon(Icons.star_border_outlined,color: Palette.primaryColor,size: 17.sp,),
                          SizedBox(
                            width: 10.w,),
                          Container(
          ...
          Container(
             width: 1.sw,
              ...
              child:Container(
                ...
                child: TextButton(
                  onPressed: (){},
                  child: Text("Book Now", style: Theme.of(context).textTheme.headline3!.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: 18.sp,
                      color:Colors.white
                  ),),
